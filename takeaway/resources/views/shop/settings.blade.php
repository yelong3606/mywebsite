                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="{{$shop->title}}" class="form-control" placeholder="Shop title">
                        </div>
                        <div class="form-group">
                            <label for="">Description</label>
                            <textarea name="description" class="form-control" rows="5">{{$shop->description}}</textarea>
                        </div>
                        <div class="form-group">
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="addr_1" value="{{$shop->addr_1}}" class="form-control mb-2" placeholder="Address line 1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="autocomplete" style="width:300px;">
                                <input type="text" id="regionsAutoComplete" name="addr_town" value="{{$shop->addr_town}}" class="form-control"
                                    placeholder="e.g. Clonsilla">
                            </div>
                        </div>
                    </div>
                </div>
